...
def get_args_parser():
    ...
    parser.add_argument('--itm_loss_coef', default=1, type=float)
...
def main(args):
    ...
    args.object_names = dataset_train.get_objects()
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch % 5 == 0:
            checkpoint_path = os.path.join(output_dir, f'{epoch}_checkpoint.pth')
