...
from models.muren import build_muren
from models.hoi import MURENHOI
...
def main(args):
    ...
    # with open(args.save_path[:-12] + 'total.pkl', 'wb') as f:
    #     pickle.dump(targets, f, protocol=2)
...
def generate(model, post_processor, data_loader, device, verb_classes, missing_category_id):
    ...
    detections = []
    for samples, targets, raw_img in metric_logger.log_every(data_loader, 10, header):
